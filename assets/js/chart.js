import btcusdt_jan_2021 from '../csv/kline_data/btcusdt/1d/BTCUSDT-1d-2021-01.json' assert {type: 'json'};
...
const select_market = document.querySelector('#select-market__button');

// select_market.addEventListener('click', () => {
//     select_market.classList.toggle('dropdown');
// })


candle_series.setData(btcusdt_jan_2021);
